...
public class EventAdapter extends ArrayAdapter<Events>{
	public EventAdapter(Context context, ArrayList<Events> events) {
		...
		Log.d("DEBUG", "Number of events passed -- " + events.size());
	}
	
	public View getView(int position, View view, ViewGroup parent) {
		Events e = getItem(position);
		Log.d("DEBUG", "Minute: " + e.getMinute() + " Name: " + e.getName() + 
				" Type: " + e.getType() + " Side: " + e.getSide());
		view = null;
		if(view == null){
			...
			if(position == 0){	// match snippet
				...
				if(r.getLiveTime().equals("")){
					...
					TextView homeName = (TextView) view.findViewById(R.id.tvHomeName);
					TextView awayName = (TextView) view.findViewById(R.id.tvAwayName);
					homeName.setText(r.getHomeTeam());
					awayName.setText(r.getAwayTeam());
			
					TextView homeScore = (TextView) view.findViewById(R.id.tvHomeScore);
					TextView awayScore = (TextView) view.findViewById(R.id.tvAwayScore);
				...
				ImageView ivEventType = (ImageView) view.findViewById(R.id.ivEventType);
	...
	private Drawable getIcon(String type){
		if(type.equals("goal")){
			return getContext().getResources().getDrawable(R.drawable.ic_football_72);
		}
		else if(type.equals("yellow")){
			return getContext().getResources().getDrawable(R.drawable.yellow_72);
		}
